...
using Poppel.Models.HelperClasses;
...
namespace Poppel.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Cost,image,image2")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Cost,image,image2")] Product product)
        {
            if (ModelState.IsValid)
            {
